...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for haya14busa/xtag

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/haya14busa/xtag/releases
...
get_binaries() {
  case "$PLATFORM" in
    darwin/386) BINARIES="xtag" ;;
    darwin/amd64) BINARIES="xtag" ;;
    linux/386) BINARIES="xtag" ;;
    linux/amd64) BINARIES="xtag" ;;
    *)
